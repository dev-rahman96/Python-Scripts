...
aws cloudformation package --template-file PrimaryRegionTemplate.yaml --s3-bucket <automatedec2snapshots>  --output-template-file tempPrimary.yaml --region us-east-1           